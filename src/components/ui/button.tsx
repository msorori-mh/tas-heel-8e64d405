...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold cursor-pointer transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-card hover:bg-primary/92 hover:shadow-card-hover",
        destructive:
        ...
        hero:
          "bg-accent text-accent-foreground shadow-card-hover ring-2 ring-accent/25 hover:bg-accent/92 hover:shadow-elevated",
        accent:
          "bg-accent text-accent-foreground shadow-card hover:bg-accent/92 hover:shadow-card-hover",
        soft: "border border-primary/15 bg-primary/10 text-primary hover:bg-primary/15",
        success: "bg-success text-success-foreground shadow-sm hover:bg-success/90",
        exam: "bg-exam-gradient text-primary-foreground shadow-card hover:opacity-95 hover:shadow-card-hover",
      },
      size: {
