...
export const STAGING_TABLES: readonly StagingTableDesign[] = [
  {
    ...
    columns: [
      ...
      c("resolved_refs", "jsonb", true, "FK ids resolved during dry-run (subject_id, lesson_id, …)"),
      c("planned_action", "text", true, "INSERT | UPDATE_DRAFT | NEW_REVISION | SKIP | BLOCKED_PUBLISHED"),
  ...
  },
  {
    ...
    columns: [
      c("id", "uuid pk", true),
      c("entity_type", "text", true, "subjects | units | lessons | lesson_explanations | lesson_assessments | questions"),
