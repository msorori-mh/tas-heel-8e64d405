...
export const IMPORT_ENTITY_CONTRACTS: Record<ContentImportTemplateKey, ImportEntityContract> = {
  ...
  questions: {
    ...
    foreignKeys: [
      ...
      "question_revisions.question_id → questions.id",
      "official_question_answers.(question_id, revision_id) → question_revisions.(question_id, id)",
    ],
    ...
    fields: [
      ...
      derived(
        ...
        "question_revisions",
        "educational_label",
        "derived by template: OFFICIAL_BOOK_QUESTION; never inferred from options",
      ),
  ...
  self_test_questions: {
    templateKey: "self_test_questions",
    table: "questions",
    naturalKey: ["question_code"],
    naturalKeyColumns: ["code"],
    uniquenessScope: "global (code IS NOT NULL)",
    ...
    fields: [
      ...
      derived(
        ...
        "question_revisions",
        "educational_label",
        "derived by template: SELF_TEST; never inferred from options",
      ),
      derived("interaction_type", "question_revisions", "interaction_type", "fixed: SINGLE_CHOICE"),
      derived("grading_mode", "question_revisions", "grading_mode", "fixed: AUTO_SINGLE"),
      f("subject_code", "subjects", null, true, "FK lookup"),
      f("lesson_code", "lessons", null, true, "FK lookup"),
      f("question_text", "question_revisions", "question_text", true),
      f("option_1", "question_options", "body", true),
      f("option_2", "question_options", "body", true),
      f("option_3", "question_options", "body", false),
      f("option_4", "question_options", "body", false),
      f("option_5", "question_options", "body", false),
      f("option_6", "question_options", "body", false),
      f("correct_index", "question_options", "is_correct", true, "1-based in Excel; editor-only"),
      f("explanation", "official_question_answers", "explanation", true, "يظهر بعد اختيار الطالب"),
      f("why_wrong_1", "question_option_rationales", "why_wrong", false),
      f("why_wrong_2", "question_option_rationales", "why_wrong", false),
      f("why_wrong_3", "question_option_rationales", "why_wrong", false),
      f("why_wrong_4", "question_option_rationales", "why_wrong", false),
      f("why_wrong_5", "question_option_rationales", "why_wrong", false),
  ...
  assessment_questions: {
    ...
    dependsOn: ["assessments", "questions", "self_test_questions"],
    foreignKeys: [
