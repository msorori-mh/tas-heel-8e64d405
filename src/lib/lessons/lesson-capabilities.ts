...
export function computeLessonCapabilities(input: LessonCapabilityInput): LessonCapability[] {
  ...
  return [
    ...
    enhancement(
      ...
      "أسئلة الكتاب",
      "حل الأسئلة",
      "أسئلة الكتاب بصيغتها الأصلية، مع إجابة نموذجية بعد المحاولة.",
      input,
      {
        trackable: true,
...
export const LESSON_CAPABILITY_LABEL_AR: Record<LessonCapabilityType, string> = {
  PRIMARY_CONTENT: "محتوى الكتاب",
  SUMMARY: "ملخص الدرس",
  EXPLANATION: "شرح تمكين",
  MINDMAP: "الخريطة الذهنية",
  PRACTICAL: "التجربة المعملية",
  VIDEO: "فيديو",
  OFFICIAL_QUESTIONS: "أسئلة الكتاب",
