...
export const DS_V2_COLORS: readonly DsColorToken[] = [
  ...
  { name: "primary", cssVar: "--primary", value: "#1E2A63", usage: "Deep Indigo — الهوية والأزرار الأساسية" },
  { name: "secondary", cssVar: "--secondary", value: "#0EA5E9", usage: "Electric Blue — التفاعل والتمييز" },
