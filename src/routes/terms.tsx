  ...
  head: () => ({
    meta: [
      { title: "شروط الاستخدام — تنوير" },
      {
        name: "description",
        content:
          "شروط استخدام منصة تنوير: الاشتراكات، الحسابات، مسؤولية بيانات الدفع، وسياسة المحتوى.",
      },
    ...
    <article className="min-h-screen bg-background px-4 py-10" dir="rtl">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <p className="text-muted-foreground">
          باستخدامك منصة "تنوير"، فإنك توافق على الالتزام بهذه الشروط. المنصة
          مخصّصة لطلاب الثانوية في اليمن لأغراض تعليمية شخصية.
        </p>
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 pr-6 text-muted-foreground">
            ...
            <li>
              أنت مسؤول عن صحة بياناتك (الاسم، الصف، المحافظة، المسار) وعن
              المحافظة على كلمة المرور.
            </li>
            <li>
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 pr-6 text-muted-foreground">
            <li>
              تُفعَّل الاشتراكات بعد مراجعة طلب الدفع وسند الحوالة من فريق
              الإدارة.
            </li>
            <li>
              مدة الاشتراك محددة عند الشراء، وينتهي تلقائيًا عند انقضاء المدة
              دون تجديد تلقائي.
            </li>
            <li>
              أنت المسؤول عن صحة بيانات الحوالة (المبلغ، رقم العملية، اسم
              المرسل، التاريخ). الإدخال الخاطئ قد يؤخّر التفعيل.
            </li>
            <li>
              المبالغ المدفوعة لا تُسترد بعد التفعيل، إلا في حالات يحددها فريق
              الدعم وفق سياسة الاسترداد.
            </li>
            <li>
              قد تُحوَّل بعض المدفوعات إلى المحفظة الداخلية كرصيد خدمة، وهي
              ليست عملة قابلة للسحب نقدًا.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 pr-6 text-muted-foreground">
            <li>
              المحتوى الدراسي (الدروس، الأسئلة، الاختبارات، الموارد) ملك
              لمنصة تنوير، يُستخدم للأغراض التعليمية الشخصية فقط.
            </li>
            <li>
              ممنوع نسخ المحتوى أو إعادة نشره أو بيعه أو استخدامه في تطبيقات
              أخرى دون إذن خطي.
            </li>
            <li>
              التعليقات أو المساهمات من المستخدمين يجب أن تكون محترمة وذات صلة
              بالمادة الدراسية.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="mt-2 text-muted-foreground">
            نسعى لتوفير خدمة مستقرة، لكن لا نضمن خلوّها من الانقطاع أو الأخطاء.
            المحتوى التعليمي مرجعي ولا يُغني عن المنهج الرسمي أو المعلم.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2 text-muted-foreground">
            قد نُحدّث هذه الشروط من وقت لآخر. سنُعلم المستخدمين بالتغييرات
            الجوهرية. الاستمرار في الاستخدام بعد التحديث يعني الموافقة.
          </p>
        </section>
