...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "تمكين منصة رقمية تعليمية متخصّصة لطلاب الثانوية في اليمن — دروس وملخصات وبنوك أسئلة حسب المنهج والمحافظة." },
      { property: "og:title", content: "عن تمكين — منصة تعليمية لطلاب الثانوية في اليمن" },
      { property: "og:description", content: "تمكين منصة رقمية تعليمية متخصّصة لطلاب الثانوية في اليمن — دروس وملخصات وبنوك أسئلة حسب المنهج والمحافظة." },
    ...
    <article className="min-h-screen bg-background px-4 py-10">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-4 text-muted-foreground leading-loose">
          تمكين منصة تعليمية رقمية مخصّصة لطلاب الثانوية في اليمن. نُقدّم الدروس،
