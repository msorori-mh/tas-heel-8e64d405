      ...
      <main className="mx-auto max-w-5xl space-y-8 pb-24" dir="rtl">
        ...
        <section className="space-y-3" aria-labelledby="contents-import-heading">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              اختر الدرس وارفع ما جهز من مكوناته: خمسة مكونات HTML، وقالبا Excel لأسئلة الكتاب
              و«اختبر فهمك». لا مكوّن إلزامي، ولكل مكوّن زر نشر خاص به: بعد نجاح الفحص يُنشر وحده
              ويظهر للطالب فورًا دون انتظار بقية المكوّنات.
            </p>
          </div>
