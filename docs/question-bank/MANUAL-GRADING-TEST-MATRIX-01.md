...
| **TC-DMA-008** | التقييم المزدوج المتوافق (لا تباين) | `system` | درجة الأول 8/10 والثاني 8.5/10 | تسليم التقييمين بحساب تباين 5% | الاعتماد التلقائي المباشر بحالة `FINALIZED` | `REQUIRED_EXTENSION` | `RPC` | YES | YES | ODR-013 |
...
| **TC-AFR-007** | الاعتماد الفوري للتمارين التدريبية | `grader` | محاولة تدريب حرة طليقة | تقديم التقييم والاعتماد الفوري | تحديث درجة التمرين فوراً وإتاحة النتيجة | `OWNER_DECISION` | `RPC` | YES | YES | ODR-016 |
