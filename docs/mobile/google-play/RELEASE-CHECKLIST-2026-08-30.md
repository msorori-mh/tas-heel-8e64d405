...
تاريخ التدقيق: 2026-08-31. النطاق: Android 1.0.1، الحزمة `app.studentamkeen.tamkeen`، دون رفع إلى Play أو نشر إنتاج.
...
| Version                  | PASS_SOURCE                     | `versionCode 2` و`versionName 1.0.1`؛ رُفع الرقم لأن Google Play سجّل `versionCode 1` سابقًا                                             |
