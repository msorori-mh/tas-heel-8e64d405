...
const templates = [
  ...
  },
  {
    ...
    notes: [
      ...
      "model_answer إلزامي ويظهر فقط بعد أن يحاول الطالب الإجابة.",
    ],
  },
  {
    ...
    columns: [
      ...
      { key: "option_3", header: "option_3", required: true, example: "واط" },
      { key: "option_4", header: "option_4", required: true, example: "باسكال" },
      { key: "correct_index", header: "correct_index", required: true, example: 1, note: "1=option_1 … 4=option_4 — للمحررين فقط" },
    ...
    notes: [
      ...
      "why_wrong_1…4: املأ تعليل كل خيار خاطئ؛ ويجوز ترك تعليل الخيار الصحيح فارغًا.",
    ],
  },
];
