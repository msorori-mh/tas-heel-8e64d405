...
const templates = [
  ...
  },
  {
    ...
    exampleRows: [
      ["sub-g10-001", "lesson-g10-001-001", "res-g10-001-001-01", "video", "شرح وحدات القياس", "فيديو YouTube تعليمي", "https://www.youtube.com/watch?v=example", "url", "", "", "لا", 1, "قناة تعليمية — مثال", "YouTube Standard License", "رابط خارجي — تحقق من حقوق النشر"],
      ["sub-g10-001", "lesson-g10-001-001", "RES-PHYS-G10-U1-L1-02", "mindmap", "خريطة وحدات القياس", "خريطة HTML self-contained", "", "html", "assets/lesson-g10-001-001-mindmap.html", "", "نعم", 2, "أداة Gemini — مثال", "CC BY-SA — احتفظ بالنسب", "ملف HTML محلي — RTL وجوال"],
      ["sub-g10-001", "lesson-g10-001-001", "RES-PHYS-G10-U1-L1-03", "experiment", "محاكاة الكثافة", "تجربة PhET مع wrapper HTML", "https://phet.colorado.edu/sims/html/density/latest/density_all.html", "html", "assets/lesson-g10-001-001-density.html", "", "نعم", 3, "PhET Interactive Simulations", "PhET CC BY — لا تنسخ المحاكاة", "embed الرابط الرسمي فقط"],
      ["sub-g10-001", "lesson-g10-001-001", "RES-PHYS-G10-U1-L1-04", "pdf", "ملخص الدرس — PDF", "ملف PDF للطباعة", "", "pdf", "assets/lesson-g10-001-001-summary.pdf", "", "لا", 4, "إنتاج داخلي", "حقوق داخلية", "يُرفع الملف لاحقاً عبر لوحة الإدارة"],
      ["sub-g10-001", "lesson-g10-001-001", "RES-PHYS-G10-U1-L1-05", "link", "مرجع وزارة التربية", "رابط مرجع رسمي", "https://example.gov.ye/curriculum", "url", "", "", "لا", 5, "وزارة التربية والتعليم", "رابط عام — تحقق من الترخيص", "لا تزِل attribution للموارد المرخّصة"],
    ],
    notes: [
      ...COMMON_NOTES,
      RESOURCE_TYPES_NOTE,
  ...
  },
  {
    ...
    columns: [
      { key: "question_code", header: "question_code", required: true, example: "q-g10-001-00001" },
      { key: "lesson_code", header: "lesson_code", example: "lesson-g10-001-001", note: "اختياري — للأسئلة العامة اتركه فارغاً" },
      { key: "subject_code", header: "subject_code", example: "sub-g10-001" },
      ...
      { key: "question_type", header: "question_type", example: "mcq" },
      { key: "year", header: "year", example: "" },
      { key: "semester", header: "semester", example: 1 },
      { key: "sort_order", header: "sort_order", example: 1 },
      { key: "review_status", header: "review_status", example: "مسودة" },
    ],
    exampleRows: [
      ["q-g10-001-00001", "lesson-g10-001-001", "sub-g10-001", "ما وحدة قياس القوة في SI؟", "نيوتن", "جول", "واط", "باسكال", "", "", 1, "القوة تُقاس بالنيوتن", "mcq", "", 1, 1, "مسودة"],
    ],
