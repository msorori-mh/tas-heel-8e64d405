...
const RESOURCE_TYPES_NOTE = "resource_type المسموحة: video | mindmap | experiment | pdf | link";
...
const templates = [
    ...
    columns: [
      {
        ...
        required: true,
        example: "sub-g10-001",
        note: "كود فريد للمادة يولّده النظام (TCS-2) — لا يتغير ولا يحتوي المسار",
      },
      {
        key: "name",
        header: "name",
        required: true,
        example: "اللغة العربية - النحو",
        note: "اسم المادة كما يظهر للطالب",
      },
      {
        key: "group_code",
        header: "group_code",
        example: "grp-g10-01",
        note: "اختياري — لتجميع أقسام مادة واحدة (SUBJECT_AS_BRANCH)",
      },
      {
        key: "group_name",
        header: "group_name",
        example: "اللغة العربية",
        note: "اسم المجموعة المعروض — موحّد لكل الأقسام",
      },
      { key: "grade_slug", header: "grade_slug", required: true, example: "grade-10" },
      {
        ...
        required: true,
        example: "sanaa|aden",
        note: "مسار أو أكثر مفصولة بـ | — المادة المشتركة تُدخل مرة واحدة",
      },
    ...
    columns: [
      {
        ...
        required: true,
        example: "sub-g10-001",
        note: "إلزامي — يحدد المادة التي ينتمي إليها lesson_code",
      },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "lesson_code", header: "lesson_code", required: true, example: "lesson-g10-001-001" },
      {
        ...
        required: true,
        example: "exp-g10-001-001-01",
        note: "هوية ثابتة للشرح — لا تغيّرها بين الدفعات",
      },
      { key: "title", header: "title", required: true, example: "شرح النظام الدولي للوحدات" },
      {
        ...
        header: "content",
        required: true,
        example: "النظام الدولي SI يعتمد على...",
      },
      { key: "sort_order", header: "sort_order", example: 1 },
      { key: "review_status", header: "review_status", example: "مسودة" },
    ],
  ...
  },
  {
    ...
    columns: [
      ...
      {
        key: "resource_code",
        header: "resource_code",
        required: true,
        example: "res-g10-001-001-01",
        note: "هوية ثابتة للمورد — لا تغيّرها بين الدفعات",
      },
      {
        key: "resource_type",
      ...
      { key: "description", header: "description", example: "فيديو YouTube تعليمي" },
      {
        ...
        note: "إلزامي — رابط خارجي أو embed رسمي",
      },
      {
        key: "resource_format",
        header: "resource_format",
        example: "url",
        note: "url | html | pdf",
      },
      {
        key: "local_asset_path",
        header: "local_asset_path",
        example: "assets/lesson-g10-001-001-mindmap.html",
        note: "مسار نسبي للملف المحلي",
      },
      ...
      { key: "sort_order", header: "sort_order", example: 1 },
      {
        ...
        note: "إلزامي للموارد الخارجية",
      },
      {
        key: "license_note",
        header: "license_note",
        example: "CC BY — احتفظ بالنسب",
        note: "لا تحذف attribution إلا إذا يسمح الترخيص",
      },
      { key: "notes", header: "notes", example: "رابط خارجي فقط" },
      {
        ...
        header: "is_primary",
        example: "لا",
        note: "نعم = هذا المورد هو محتوى الدرس نفسه (ملف PDF/Drive) — مورد واحد فقط لكل درس",
      },
    ],
    exampleRows: [
      [
        ...
        "رابط خارجي — تحقق من حقوق النشر",
        "لا",
      ],
      [
        "sub-g10-001",
        "lesson-g10-001-001",
        "RES-PHYS-G10-U1-L1-02",
        "mindmap",
        "خريطة وحدات القياس",
        "خريطة HTML self-contained",
        "",
        "html",
        "assets/lesson-g10-001-001-mindmap.html",
        "",
        "نعم",
        2,
        "أداة Gemini — مثال",
        "CC BY-SA — احتفظ بالنسب",
        "ملف HTML محلي — RTL وجوال",
        "لا",
      ],
      [
        "sub-g10-001",
        "lesson-g10-001-001",
        "RES-PHYS-G10-U1-L1-03",
        "experiment",
        "محاكاة الكثافة",
        "تجربة PhET مع wrapper HTML",
        "https://phet.colorado.edu/sims/html/density/latest/density_all.html",
        "html",
        "assets/lesson-g10-001-001-density.html",
        "",
        "نعم",
        3,
        "PhET Interactive Simulations",
        "PhET CC BY — لا تنسخ المحاكاة",
        "embed الرابط الرسمي فقط",
        "لا",
      ],
      [
        "sub-g10-001",
        "lesson-g10-001-001",
        "RES-PHYS-G10-U1-L1-04",
        "pdf",
        "ملخص الدرس — PDF",
        "ملف PDF للطباعة",
        "",
        "pdf",
        "assets/lesson-g10-001-001-summary.pdf",
        "",
        "لا",
        4,
        "إنتاج داخلي",
        "حقوق داخلية",
        "يُرفع الملف لاحقاً عبر لوحة الإدارة",
        "لا",
      ],
      [
        "sub-g10-001",
        "lesson-g10-001-001",
        "RES-PHYS-G10-U1-L1-05",
        "link",
        "مرجع وزارة التربية",
        "رابط مرجع رسمي",
        "https://example.gov.ye/curriculum",
        "url",
        "",
        "",
        "لا",
        ...
        "رابط عام — تحقق من الترخيص",
        "لا تزِل attribution للموارد المرخّصة",
        "لا",
      ],
    ],
    notes: [
  ...
  },
  {
    ...
    columns: [
      {
        key: "assessment_code",
        header: "assessment_code",
        required: true,
        example: "asm-g10-001-001-01",
      },
      {
        key: "subject_code",
        header: "subject_code",
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "lesson_code", header: "lesson_code", required: true, example: "lesson-g10-001-001" },
      {
        ...
        required: true,
        example: "تعليل",
        note: "تعريف | تعليل | سؤال_قصير | شرح | اختيار_واحد | أخرى",
      },
      {
        key: "question_text",
        header: "question_text",
        required: true,
        example: "علل: تعد وحدات القياس ضرورية في الفيزياء.",
        note: "النص الأصلي كما ورد في الكتاب دون إعادة صياغة",
      },
      {
        ...
        required: true,
        example: "LONG_TEXT",
        note: "LONG_TEXT | SHORT_TEXT | SINGLE_CHOICE",
      },
      {
        key: "grading_mode",
        header: "grading_mode",
        required: true,
        example: "MANUAL",
        note: "MANUAL | AUTO_TEXT | AUTO_SINGLE",
      },
      ...
      {
        key: "correct_index",
        header: "correct_index",
        example: "",
        note: "مطلوب فقط إذا كان النوع SINGLE_CHOICE",
      },
      {
        key: "accepted_answers",
        header: "accepted_answers",
        example: "",
        note: "مطلوب فقط إذا كان النوع SHORT_TEXT؛ افصل القيم بـ |",
      },
      {
        key: "model_answer",
        header: "model_answer",
        required: true,
        example: "لأنها توحّد التعبير الكمي وتسمح بالمقارنة الدقيقة.",
        note: "تظهر بعد محاولة الطالب",
      },
      {
        key: "explanation",
        header: "explanation",
        example: "الإجابة تربط القياس بالدقة وإمكانية المقارنة.",
      },
      { key: "sort_order", header: "sort_order", example: 1 },
      { key: "review_status", header: "review_status", example: "مسودة" },
    ],
    exampleRows: [
      [
        ...
        "lesson-g10-001-001",
        "تعليل",
        "علل: تعد وحدات القياس ضرورية في الفيزياء.",
        "LONG_TEXT",
        "MANUAL",
        "",
        "",
        ...
        "",
        "",
        "لأنها توحّد التعبير الكمي وتسمح بالمقارنة الدقيقة.",
        "",
        1,
        "مسودة",
      ],
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "lesson_code", header: "lesson_code", required: true, example: "lesson-g10-001-001" },
      {
        ...
        header: "question_text",
        required: true,
        example: "ما وحدة قياس القوة في النظام الدولي؟",
      },
      ...
      { key: "option_6", header: "option_6", example: "" },
      {
        ...
        required: true,
        example: 1,
        note: "1=option_1 … 6=option_6 — للمحررين فقط",
      },
      {
        key: "explanation",
        header: "explanation",
        required: true,
        example: "النيوتن هو وحدة القوة في النظام الدولي.",
      },
    ...
    exampleRows: [
      [
        ...
        "",
        1,
        "النيوتن هو وحدة القوة في النظام الدولي.",
        "",
        "الجول وحدة طاقة وليس قوة.",
        "الواط وحدة قدرة وليس قوة.",
        "الباسكال وحدة ضغط وليس قوة.",
        "",
        "",
        1,
        "مسودة",
...
function fillCodeReferenceSheet(ws) {
  ...
  ws.addRow([`مرجع الأكواد الرسمي — ${CONTENT_CODE_SCHEME_VERSION}`]).font = {
    bold: true,
    size: 14,
  };
  ws.addRow([]);
