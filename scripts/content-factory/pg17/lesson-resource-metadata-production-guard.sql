-- Exact PG17 copy of the production metadata guard from
-- 20260824010000_cf11_rapid_launch_contract_alignment.sql. A static test keeps
-- the function body byte-aligned with that migration.
