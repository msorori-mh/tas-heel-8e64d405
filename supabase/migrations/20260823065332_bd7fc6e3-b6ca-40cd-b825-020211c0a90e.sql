...
AS $$
BEGIN
  -- Protect every canonical capability of a CF11-managed READY lesson, whether its
  -- verified profile classified it REQUIRED or OPTIONAL. Applicability controls intake
  -- requirements; it must never weaken the post-publication withdrawal boundary.
