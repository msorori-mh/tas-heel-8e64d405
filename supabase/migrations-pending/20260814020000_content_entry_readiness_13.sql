...
-- Adds SUBJECT_AS_BRANCH grouping (group_code / group_name) support to
-- import_execute_template for template 01 (subjects).
-- group_code is immutable once set; group_name follows the existing
-- assert_subject_group_name_consistent trigger.
