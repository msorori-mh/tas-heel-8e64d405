...
INSERT INTO public.question_revisions (id, question_id, revision_number, status, interaction_type, grading_mode,
  ...
  ('77777777-0000-0000-0000-0000000000a1', '66666666-0000-0000-0000-00000000000a', 1, 'SUPERSEDED', 'SINGLE_CHOICE', 'AUTO_SINGLE', 'Question A text', 1, false, false, false, '11111111-1111-1111-1111-111111111111', now(), '11111111-1111-1111-1111-111111111111', repeat('a1', 32), 'canonical_payload_v1'),
