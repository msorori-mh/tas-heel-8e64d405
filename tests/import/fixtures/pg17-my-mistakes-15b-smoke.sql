...
INSERT INTO public.exam_session_questions (id, exam_session_id, question_revision_id, logical_question_id,
  ...
  ('aaaaaaaa-0000-0000-0000-000000000007', '99999999-0000-0000-0000-000000000003', '77777777-0000-0000-0000-0000000000a1', '66666666-0000-0000-0000-00000000000a', 1, 'Question A text', '[]'::jsonb, 1, 'REVISION_PINNED', repeat('e1', 32), 'canonical_payload_v1'),
